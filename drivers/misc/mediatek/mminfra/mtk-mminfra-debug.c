			...
			unsigned long flags, void *data)
{
	...
	if (flags == GENPD_NOTIFY_ON) {
		...
		//cmdq_util_mminfra_cmd(0); // TEST: disable mminfra init SMC
		//cmdq_util_mminfra_cmd(3); // TEST: disable mminfra rfifo init SMC
		//do_mminfra_bkrs(true); // TEST: disable SCMI mminfra restore
		...
		//do_mminfra_bkrs(false); // TEST: disable SCMI mminfra backup
