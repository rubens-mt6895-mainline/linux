...
int fts_read(u8 *outBuf, int byteToRead)
{
	...
	transfer[0].delay.value = SPI_DELAY_CS; transfer[0].delay.unit = SPI_DELAY_UNIT_USECS;
...
int fts_writeRead(u8 *cmd, int cmdLength, u8 *outBuf, int byteToRead)
{
	...
	transfer[1].delay.value = SPI_DELAY_CS; transfer[1].delay.unit = SPI_DELAY_UNIT_USECS;
			   ...
			   int readCmdLength, u8 *outBuf, int byteToRead)
{
	...
	transfer[2].delay.value = SPI_DELAY_CS; transfer[2].delay.unit = SPI_DELAY_UNIT_USECS;
